  ...
  private selectedCorner: THREE.Mesh | null = null;
    ...
    boundingBoxEditData: {
      ...
      private updateDimensionMaintainingNormalizedScale(newPosition: THREE.Vector3, axis: 'x' | 'y' | 'z') {
        ...
        console.log('Updated dimensions maintaining scale:',
                    this.boundingBoxEditData.dimensionX.toFixed(2),
                    this.boundingBoxEditData.dimensionY.toFixed(2),
                    this.boundingBoxEditData.dimensionZ.toFixed(2));
      ...
      private initializeNormalizedScale() {
        if (this.boundingBoxEditData) {
          ...
          console.log('Initialized normalized scale ratios:', 
                      this.boundingBoxEditData.normalizedRatioX,
                      this.boundingBoxEditData.normalizedRatioY,
                      this.boundingBoxEditData.normalizedRatioZ);
        }
      }
